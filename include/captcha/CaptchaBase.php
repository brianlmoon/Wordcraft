...
class CaptchaBase {
    ...
    * which will be called to create a CAPTCHA.
...
//        $strings = $this->generate_text_strings();
        ...
        '<div id="spamhurdles_captcha_explain">Enter the text above into the box below.<br />If you are unable to read it, refresh the page.</div>' .
    ...
    */
    public function generate_question_and_answer() {
    ...
    */
    public function generate_spoken_captcha_text($question) {
    ...
    */
    public function check_answer($info) {
